                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="usage"
                                                  ...
                                                  placeholder="Pisahkan tiap langkah dengan titik koma (;)">{{ old('usage', $product->usage) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               class="form-control"
                                               value="{{ old('extra_categories_input', is_array($product->extra_categories) ? implode('; ', $product->extra_categories) : $product->extra_categories) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @php $selectedIds = old('voucher_ids', $product->vouchers->pluck('id')->toArray()); @endphp
                                    @forelse($vouchers ?? [] as $v)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="voucher_ids[]" value="{{ $v->id }}" id="voucher_{{ $v->id }}" {{ in_array($v->id, $selectedIds) ? 'checked' : '' }}>
