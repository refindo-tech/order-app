        ...
        <div class="col-md-12">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h4 class="c-grey-900 mB-0">Tambah Artikel Baru</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="bgc-white bd bdrs-3 p-20">
                <form id="articleFormCreate" action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('slug')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Slug SEO friendly, misal: <code>tips-memilih-parcel-buah</code></small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="excerpt"
                                                  ...
                                                  rows="3"
                                                  maxlength="250">{{ old('excerpt') }}</textarea>
                                        @error('excerpt')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('category')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Kategori bebas (opsional), untuk pengelompokan artikel.</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <small class="text-muted">Konten rich text (heading, bold, list, link, dll).</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted d-block">
                                            Jika kosong dan status <strong>Publish</strong>, akan diisi otomatis dengan waktu sekarang.
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label">Thumbnail Artikel <span class="text-danger">*</span></label>
                                        <input type="file"
                                               name="thumbnail"
                                        ...
                                        @enderror
                                        <small class="text-muted d-block">
                                            Wajib diisi. Format: jpg, jpeg, png, gif, webp. Maksimal 2MB.
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary">
                                    <i class="ti-save me-2"></i>Simpan Artikel
                                </button>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        (function () {
            const form = document.getElementById('articleFormCreate');
            if (!form) return;
